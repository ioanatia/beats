...
|<<metricbeat-module-app_search,app_search>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-app_search-stats,stats>> beta[]  
...
include::modules/app_search.asciidoc[]
