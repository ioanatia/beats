...
*`app_search.stats.jvm.memory_usage.heap_init.bytes`*::
+
--
...
*`app_search.stats.jvm.memory_usage.heap_used.bytes`*::
+
--
...
*`app_search.stats.jvm.memory_usage.heap_committed.bytes`*::
+
--
...
*`app_search.stats.jvm.memory_usage.heap_max.bytes`*::
+
--
...
*`app_search.stats.jvm.memory_usage.non_heap_init.bytes`*::
+
--
...
*`app_search.stats.jvm.memory_usage.non_heap_committed.bytes`*::
+
--
...
*`app_search.stats.queues.analytics_events.count`*::
+
--
...
*`app_search.stats.queues.document_destroyer.count`*::
+
--
...
*`app_search.stats.queues.engine_destroyer.count`*::
+
--
...
*`app_search.stats.queues.index_adder.count`*::
+
--
...
*`app_search.stats.queues.indexed_doc_remover.count`*::
+
--
...
*`app_search.stats.queues.mailer.count`*::
+
--
...
*`app_search.stats.queues.refresh_document_counts.count`*::
+
--
...
*`app_search.stats.queues.reindexer.count`*::
+
--
...
*`app_search.stats.queues.schema_updater.count`*::
+
--
...
*`app_search.stats.queues.failed.count`*::
+
--
...
*`app_search.stats.requests.count`*::
+
--
...
*`app_search.stats.requests.api.duration.avg.ms`*::
+
--
...
*`app_search.stats.requests.api.duration.max.ms`*::
+
--
...
*`app_search.stats.requests.web.duration.avg.ms`*::
+
--
Average response time in milliseconds
...
*`app_search.stats.requests.web.duration.mean.ms`*::
+
--
Max response time in milliseconds
